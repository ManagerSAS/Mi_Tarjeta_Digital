        ...
        meta: [
            {
                hid: "description",
                name: "description",
                content: "Esta es la tarjeta digital de ALVIS MERCADO"
            }
        ],
        link: [{ rel: "icon", type: "image/x-icon", href: "/LosOlivosSantaMarta/Alvis_Asesora_Homenajes/Images/foto.ico" }]
    },
}
</script>