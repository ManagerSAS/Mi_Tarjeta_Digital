<template>
    <div class="FondoOlivos " >
        <RedesSociales/>
        <Welcome foto="LosOlivosSantaMarta/Leonardo_Coordinador_Homenajes/Images/foto.png" name="LEONARDO GUARNIZO" cargo="Coordinador de Homenajes"/>
        <CallActions  Whatsapp="https://api.whatsapp.com/send?phone=573008519064" tel="tel:+573008519064" contacto="/LosOlivosSantaMarta/Leonardo_Coordinador_Homenajes/Contact/ContactoLeonardoOlivos.vcf" email="mailto:coordinacionsantamarta@losolivos.co" web="https://www.losolivossantamarta.com/" url="https://mitarjetadigital.co/Manager/Abel_Rodriguez_Gerente"/>
        <Services/>
        <Adicionales Qr="/LosOlivosSantaMarta/Leonardo_Coordinador_Homenajes/Images/QR.jpg" QrD="/LosOlivosSantaMarta/Leonardo_Coordinador_Homenajes/Images/QRDowload.jpg"/>
        <Footer/>
    </div>
</template>
<script>
...
export default {
    ...
    head: {
        ...
        link: [{ rel: "icon", type: "image/x-icon", href: "/LosOlivosSantaMarta/Leonardo_Coordinador_Homenajes/Images/foto.ico" }]
    },
}
</script>