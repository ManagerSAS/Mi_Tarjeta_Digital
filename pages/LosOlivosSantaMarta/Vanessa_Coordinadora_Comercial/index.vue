<template>
    <div class="FondoOlivos " >
        <RedesSociales/>
        <Welcome foto="LosOlivosSantaMarta/Vanessa_Coordinadora_Comercial/Images/foto.png" name="DIEGO MORALES" cargo="Gerente"/>
        <CallActions  Whatsapp="https://api.whatsapp.com/send?phone=573008504730" tel="tel:+573008504730" contacto="/LosOlivosSantaMarta/Vanessa_Coordinadora_Comercial/Contact/DiegoMorales.vcf" email="mailto:gerenciasantamarta@losolivos.co" web="https://www.losolivossantamarta.com/" url="https://mitarjetadigital.co/Manager/Abel_Rodriguez_Gerente"/>
        <Services/>
        <Adicionales/>
        <Footer/>
    </div>
...
export default {
    ...
    head: {
        ...
        link: [{ rel: "icon", type: "image/x-icon", href: "/LosOlivosSantaMarta/Vanessa_Coordinadora_Comercial/Images/foto.ico" }]
    },
}
</script>