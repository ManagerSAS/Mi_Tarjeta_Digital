<template>
    <v-container fluid id="Tarjeta">
        <div justify="center" align="center">
            ...
            <div class="text-blue-f-1em mt-10" >
        ...
        <v-row justify="center" align="center">
            ...
            <v-col cols="12" xl="5" lg="5" md="5" sm="10" justify="center" align="start">
                <div class="list ml-xl-15 ml-lg-15 mt-xl-15 mt-lg-15 mt-md-10">
                    <p><v-icon color="green">mdi-check-circle</v-icon>Código QR para lectura del micrositio.</p>
                    <p><v-icon color="green">mdi-check-circle</v-icon>Chip NFC de acercamiento</p>
                ...
                <div justify="center" align="center">
                    <a href="https://api.whatsapp.com/send?phone=573242892413&text=!Hola!%2C%20Quiero%20adquirir%20mi%20tarjeta%20digital" target="_blanck"><button aria-label="Adquiere tu tarjeta digital" aria-hidden="true" class="mt-lg-10 mr-md-10 mt-md-10 mr-lg-10 mb-2 pa-2 btnContac btn-hover-advantage ">CONTÁCTANOS</button></a>
                </div>
            </v-col>
        </v-row>
    </v-container>
