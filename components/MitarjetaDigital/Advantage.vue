<template>
    <v-container fluid id="Advantage">
        <div justify="center" align="center">
            <div class="text-border-ventajas mt-2">VENTAJAS DE USAR</div>
            <div class="text-mitarjeta">MITARJETADIGITAL.CO</div>
        </div>
        <v-row justify="center" align="center">
            <v-col justify="start" align="start" cols="12" xl="5" lg="5" md="5" sm="11">
                <p class="text-blue-f-2em mt-10 mt-lg-0">Ahora la tarjeta de presentacion.</p>
                <p class="text-blue-f-4em">es virtual.</p>
                <v-row  class="list  mt-lg-10">
                    <v-col cols="12" xl="10" lg="10" md="10" sm="11" justify="center" align="start">
